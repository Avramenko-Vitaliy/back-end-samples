package com.sample.spring.kafka.config;
...
import static com.sample.spring.kafka.BaseControllerTest.kafka;
...
public class KafkaTestConfig {
    ...
    public Map<String, Object> consumerConfigs() {
        ...
        props.put(ConsumerConfig.GROUP_ID_CONFIG, "users-api");
    ...
    @Bean
    @Primary
    public KafkaAdmin adminConfigs() {
